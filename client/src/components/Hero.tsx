  ...
  return (
    <section className="relative h-screen min-h-[600px] w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center text-white px-6 max-w-6xl mx-auto">
        ...
        <h1 className="font-serif text-6xl md:text-7xl lg:text-9xl font-bold mb-6 md:mb-8 tracking-tight leading-tight drop-shadow-2xl">
          Fishtail Cuisine
        </h1>
        ...
        <p className="text-xl md:text-2xl lg:text-3xl mb-12 md:mb-16 max-w-4xl mx-auto font-light tracking-wide drop-shadow-lg">
